...
Java_com_example_mazeapp_frameproc_frpfxn(
        JNIEnv *env,
        jobject /* this */,
        jbyteArray barr) {
...
Java_com_example_mazeapp_apithread_apirunmt(
        JNIEnv *env,
        jobject /* this */,
        jobjectArray buffer){
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_example_mazeapp_apithread_apirun(
        JNIEnv *env,
        jobject /* this */,
        jobjectArray buffer){
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_example_mazeapp_apithread_apirunhmm(
        JNIEnv *env,
        jobject /* this */,
        jobjectArray buffer){
